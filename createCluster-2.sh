...
echo $CLUSTER_DEFINITION > clusterDefinition-2.json
echo clusterDefinition-2.json created

# generate the ARM template
echo Invoking acs-engine to generate ARM template.
acs-engine generate ./clusterDefinition-2.json
...
echo All Done!! Created new files: acsEngine_rsa, acsEngine_rsa.pub, clusterDefinition-2.json and config. Created folder: _output